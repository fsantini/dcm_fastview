#############################################################################
# Makefile for building: dcm_fastview
# Generated by qmake (3.1) (Qt 5.15.7)
# Project:  dcm_fastview.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile dcm_fastview.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DHAVE_CONFIG_H -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I/usr/include/dcmtk -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = dcm_fastview1.0.0
DISTDIR = /home/francesco/work/workspace/dcm_fastview/.tmp/dcm_fastview1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=12 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -lz -ldcmimgle -ldcmimage -ltiff -ldcmdata -lofstd /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		dcm_fastview.pro DcmPixmap.h \
		findStringLineEdit.h DcmPixmap.cpp \
		dcm_fastview_main.cpp \
		findStringLineEdit.cpp
QMAKE_TARGET  = dcm_fastview
DESTDIR       = 
TARGET        = dcm_fastview
...
dcm_fastview:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: dcm_fastview.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		dcm_fastview.pro
	$(QMAKE) -o Makefile dcm_fastview.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents DcmPixmap.h findStringLineEdit.h $(DISTDIR)/
	$(COPY_FILE) --parents DcmPixmap.cpp dcm_fastview_main.cpp findStringLineEdit.cpp $(DISTDIR)/
...
DcmPixmap.o: DcmPixmap.cpp DcmPixmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DcmPixmap.o DcmPixmap.cpp

dcm_fastview_main.o: dcm_fastview_main.cpp DcmPixmap.h \
		findStringLineEdit.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dcm_fastview_main.o dcm_fastview_main.cpp

findStringLineEdit.o: findStringLineEdit.cpp findStringLineEdit.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o findStringLineEdit.o findStringLineEdit.cpp
